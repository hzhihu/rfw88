...
# Database: phpcms
# Generation Time: 2013-07-07 13:37:34 +0000
# ************************************************************
...
INSERT INTO `v9_admin` (`userid`, `username`, `password`, `roleid`, `encrypt`, `lastloginip`, `lastlogintime`, `email`, `realname`, `card`, `lang`)
VALUES
	(1,'admin','f5e0239af72a199d3355e81b1f1a6d60',1,'zbidE1','127.0.0.1',1373199901,'hzhihu@gmail.com','','','');

/*!40000 ALTER TABLE `v9_admin` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v9_admin_panel
# ------------------------------------------------------------
...
INSERT INTO `v9_admin_role` (`roleid`, `rolename`, `description`, `listorder`, `disabled`)
VALUES
	(1,'超级管理员','超级管理员',0,0),
	(2,'站点管理员','站点管理员',0,0),
	(3,'运营总监','运营总监',1,0),
...
# Dump of table v9_admin_role_priv
# ------------------------------------------------------------
...
# Dump of table v9_attachment_index
# ------------------------------------------------------------
...
# Dump of table v9_block_history
# ------------------------------------------------------------
...
INSERT INTO `v9_cache` (`filename`, `path`, `data`)
VALUES
...
INSERT INTO `v9_category` (`catid`, `siteid`, `module`, `type`, `modelid`, `parentid`, `arrparentid`, `child`, `arrchildid`, `catname`, `style`, `image`, `description`, `parentdir`, `catdir`, `url`, `items`, `hits`, `setting`, `listorder`, `ismenu`, `sethtml`, `letter`, `usable_type`, `additional`, `commenttypeid`)
VALUES
...
# Dump of table v9_category_priv
# ------------------------------------------------------------
...
# Dump of table v9_collection_content
# ------------------------------------------------------------
...
# Dump of table v9_collection_history
# ------------------------------------------------------------
...
# Dump of table v9_collection_node
# ------------------------------------------------------------
...
# Dump of table v9_collection_program
# ------------------------------------------------------------
...
# Dump of table v9_comment_check
# ------------------------------------------------------------
...
# Dump of table v9_comment_data_1
# ------------------------------------------------------------
...
# Dump of table v9_comment_relation
# ------------------------------------------------------------
...
# Dump of table v9_comment_setting
# ------------------------------------------------------------
...
INSERT INTO `v9_comment_setting` (`siteid`, `guest`, `check`, `code`, `add_point`, `del_point`)
VALUES
	(1,0,0,0,0,0);
...
# Dump of table v9_comment_table
# ------------------------------------------------------------
...
INSERT INTO `v9_comment_table` (`tableid`, `total`, `creat_at`)
VALUES
	(1,0,0);
...
# Dump of table v9_content_check
# ------------------------------------------------------------
...
# Dump of table v9_dianping
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v9_dianping`;

CREATE TABLE `v9_dianping` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
# Dump of table v9_dianping_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v9_dianping_data`;

CREATE TABLE `v9_dianping_data` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `dianpingid` char(40) NOT NULL,
...
# Dump of table v9_dianping_type
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v9_dianping_type`;

CREATE TABLE `v9_dianping_type` (
...
# Dump of table v9_download_data
# ------------------------------------------------------------
...
# Dump of table v9_extend_setting
# ------------------------------------------------------------
...
INSERT INTO `v9_link` (`linkid`, `siteid`, `typeid`, `linktype`, `name`, `url`, `logo`, `introduce`, `username`, `listorder`, `elite`, `passed`, `addtime`)
VALUES
	(1,1,0,1,'PHPCMS','http://www.phpcms.cn','http://www.phpcms.cn/images/logo_88_31.gif','','',0,0,1,1373199885),
	(2,1,0,1,'网站云','http://web.grandcloud.cn','http://web.grandcloud.cn/statics/images/logo_webcloudgrand.gif','','',0,0,1,1373199885);

/*!40000 ALTER TABLE `v9_link` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v9_linkage
# ------------------------------------------------------------
...
INSERT INTO `v9_linkage` (`linkageid`, `name`, `style`, `parentid`, `child`, `arrchildid`, `keyid`, `listorder`, `description`, `setting`, `siteid`)
VALUES
...
INSERT INTO `v9_log` (`logid`, `field`, `value`, `module`, `file`, `action`, `querystring`, `data`, `userid`, `username`, `ip`, `time`)
VALUES
	(1,'',0,'admin','','module','?m=admin&c=module&a=install','',1,'admin','127.0.0.1','2013-07-07 20:46:34'),
	(2,'',0,'admin','','module','?m=admin&c=module&a=install','',1,'admin','127.0.0.1','2013-07-07 20:46:36'),
	(3,'',0,'admin','','module','?m=admin&c=module&a=cache','',1,'admin','127.0.0.1','2013-07-07 20:46:40'),
	(4,'',0,'yp','','yp','?m=yp&c=yp&a=setting','',1,'admin','127.0.0.1','2013-07-07 20:46:50'),
	(5,'',0,'admin','','plugin','?m=admin&c=plugin&a=appcenter','',1,'admin','127.0.0.1','2013-07-07 20:46:55'),
	(6,'',0,'admin','','plugin','?m=admin&c=plugin&a=import','',1,'admin','127.0.0.1','2013-07-07 20:46:56'),
	(7,'',0,'admin','','plugin','?m=admin&c=plugin&a=import','',1,'admin','127.0.0.1','2013-07-07 20:48:49'),
	(8,'',0,'member','','member_group','?m=member&c=member_group&a=manage','',1,'admin','127.0.0.1','2013-07-07 20:55:46'),
	(9,'',0,'member','','member_model','?m=member&c=member_model&a=manage','',1,'admin','127.0.0.1','2013-07-07 20:55:48'),
	(10,'',0,'member','','member_modelfield','?m=member&c=member_modelfield&a=manage','',1,'admin','127.0.0.1','2013-07-07 20:55:51'),
	(11,'',0,'member','','member_model','?m=member&c=member_model&a=manage','',1,'admin','127.0.0.1','2013-07-07 20:56:00'),
	(12,'',0,'member','','member_model','?m=member&c=member_model&a=manage','',1,'admin','127.0.0.1','2013-07-07 20:56:01'),
	(13,'',0,'member','','member_modelfield','?m=member&c=member_modelfield&a=manage','',1,'admin','127.0.0.1','2013-07-07 20:56:02'),
	(14,'',0,'yp','','additional','?m=yp&c=additional&a=add','',1,'admin','127.0.0.1','2013-07-07 20:56:20'),
	(15,'',0,'member','','member_model','?m=member&c=member_model&a=manage','',1,'admin','127.0.0.1','2013-07-07 20:56:27'),
	(16,'',0,'member','','member_model','?m=member&c=member_model&a=manage','',1,'admin','127.0.0.1','2013-07-07 21:15:06'),
	(17,'',0,'member','','member_modelfield','?m=member&c=member_modelfield&a=manage','',1,'admin','127.0.0.1','2013-07-07 21:15:07'),
	(18,'',0,'member','','member_modelfield','?m=member&c=member_modelfield&a=edit','',1,'admin','127.0.0.1','2013-07-07 21:15:09');

/*!40000 ALTER TABLE `v9_log` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v9_member
# ------------------------------------------------------------
...
# Dump of table v9_member_address
# ------------------------------------------------------------
...
# Dump of table v9_member_detail
# ------------------------------------------------------------
...
INSERT INTO `v9_member_group` (`groupid`, `name`, `issystem`, `starnum`, `point`, `allowmessage`, `allowvisit`, `allowpost`, `allowpostverify`, `allowsearch`, `allowupgrade`, `allowsendmessage`, `allowpostnum`, `allowattachment`, `price_y`, `price_m`, `price_d`, `icon`, `usernamecolor`, `description`, `sort`, `disabled`)
VALUES
...
INSERT INTO `v9_member_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `listorder`, `display`, `isurl`, `url`)
VALUES
...
# Dump of table v9_member_verify
# ------------------------------------------------------------
...
INSERT INTO `v9_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `listorder`, `display`)
VALUES
...
VALUES
	...
	(1576,'yp',2,'yp','yp','init','',0,'1'),
	(1577,'yp_setting',1576,'yp','yp','setting','',0,'1'),
	(1578,'yp_category_manage',1576,'yp','category','init','',0,'1'),
	(1579,'yp_add_category',1578,'yp','category','add','',0,'1'),
	(1580,'yp_edit_category',1578,'yp','category','edit','',0,'0'),
	(1581,'export_category',1578,'yp','category','export','',0,'0'),
	(1582,'del_category',1578,'yp','category','delete','',0,'0'),
	(1583,'listorder_category',1578,'yp','category','listorder','',0,'0'),
	(1584,'yp_model_manage',1576,'yp','ypmodel','init','',0,'1'),
	(1585,'add_yp_model',1584,'yp','ypmodel','add','',0,'0'),
	(1586,'edit_yp_model',1584,'yp','ypmodel','edit','',0,'0'),
	(1587,'del_yp_model',1584,'yp','ypmodel','delete','',0,'0'),
	(1588,'ypmodel_import',1584,'yp','ypmodel','import','',0,'1'),
	(1589,'disabled_ypmodel',1584,'yp','ypmodel','disabled','',0,'0'),
	(1590,'export_ypmodel',1584,'yp','ypmodel','export','',0,'0'),
	(1591,'yp_fields_manage',1584,'yp','ypmodel_field','init','',0,'0'),
	(1592,'add_yp_field',1591,'yp','ypmodel_field','add','',0,'0'),
	(1593,'edit_yp_field',1591,'yp','ypmodel_field','edit','',0,'0'),
	(1594,'disabled_yp_field',1591,'yp','ypmodel_field','disabled','',0,'0'),
	(1595,'delete_yp_field',1591,'yp','ypmodel_field','delete','',0,'0'),
	(1596,'listorder_yp_field',1591,'yp','ypmodel_field','listorder','',0,'0'),
	(1597,'company_template_manage',1576,'yp','template','init','',0,'1'),
	(1598,'add_new_template',1597,'yp','template','add','',0,'1'),
	(1599,'setdefaulttpl',1597,'yp','template','tpl_default','',0,'0'),
	(1600,'priv_setting',1597,'yp','template','edit_priv','',0,'0'),
	(1601,'template_disabled',1597,'yp','template','disabled','',0,'0'),
	(1602,'template_delete',1597,'yp','template','delete','',0,'0'),
	(1603,'yp_info_manage',1576,'yp','content','init','',0,'1'),
	(1604,'edit_yp_content',1576,'yp','content','edit','',0,'0'),
	(1605,'listorder_yp_content',1576,'yp','content','listorder','',0,'0'),
	(1606,'delete_yp_content',1576,'yp','content','delete','',0,'0'),
	(1607,'push_yp_content',1576,'yp','push','init','',0,'0'),
	(1608,'pass_yp_content',1576,'yp','content','pass','',0,'0'),
	(1609,'yp_company_manage',1576,'yp','company','init','',0,'1'),
	(1610,'company_edit',1609,'yp','company','edit','',0,'0'),
	(1611,'company_delete',1609,'yp','company','delete','',0,'0'),
	(1612,'company_passed_check',1609,'yp','company','passed_check','',0,'0'),
	(1613,'company_elite',1609,'yp','company','elite','',0,'0'),
	(1614,'certificate_manage',1609,'yp','certificate_ht','init','',0,'1'),
	(1615,'certificate_ht_edit',1614,'yp','certificate_ht','edit','',0,'0'),
	(1616,'certificate_delete',1614,'yp','certificate_ht','delete','',0,'0'),
	(1617,'passed_check_certificate',1614,'yp','certificate_ht','passed_check','',0,'0'),
	(1618,'batch_update',1576,'yp','update_urls','init','',0,'1'),
	(1619,'update_urls_menu',1618,'yp','update_urls','menu','',0,'0'),
	(1620,'update_urls_category',1618,'yp','update_urls','category','',0,'0'),
	(1621,'update_urls_content',1618,'yp','update_urls','content','',0,'0'),
	(1622,'additional_field',977,'yp','additional','init','',0,'1'),
	(1623,'additional_add',1622,'yp','additional','add','',0,'0'),
	(1624,'additional_edit',1622,'yp','additional','edit','',0,'0'),
	(1625,'additional_disabled',1622,'yp','additional','disabled','',0,'0'),
	(1626,'additional_delete',1622,'yp','additional','delete','',0,'0'),
	(1627,'additional_listorder',1622,'yp','additional','listorder','',0,'0');

/*!40000 ALTER TABLE `v9_menu` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v9_message
# ------------------------------------------------------------
...
# Dump of table v9_message_group
# ------------------------------------------------------------
...
INSERT INTO `v9_model` (`modelid`, `siteid`, `name`, `description`, `tablename`, `setting`, `addtime`, `items`, `enablesearch`, `disabled`, `default_style`, `category_template`, `list_template`, `show_template`, `js_template`, `sort`, `type`)
VALUES
...
INSERT INTO `v9_model_field` (`fieldid`, `modelid`, `siteid`, `field`, `name`, `tips`, `css`, `minlength`, `maxlength`, `pattern`, `errortips`, `formtype`, `setting`, `formattribute`, `unsetgroupids`, `unsetroleids`, `iscore`, `issystem`, `isunique`, `isbase`, `issearch`, `isadd`, `isfulltext`, `isposition`, `listorder`, `disabled`, `isomnipotent`)
VALUES
	...
	(84,11,1,'companyname','企业名称','','',1,100,'','请输入企业名称','text','array (\n  \'size\' => \'35\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',0,1,0,1,1,1,1,0,0,0,0),
	(85,11,1,'catids','主营行业','','size=\"8\" style=\"width:195px;\"',1,200,'','','catids','array (\n  \'boxtype\' => \'multiple\',\n  \'filtertype\' => \'1\',\n)','onchange=\"select_catids();\"','','',0,1,0,1,0,1,1,0,0,0,0),
	(86,11,1,'pattern','经营模式','','',1,255,'','','box','array (\n  \'options\' => \'生产型|生产型\r\n贸易型|贸易型\r\n服务型|服务型\r\n政府或其他机构|政府或其他机构\',\n  \'boxtype\' => \'checkbox\',\n  \'fieldtype\' => \'varchar\',\n  \'width\' => \'\',\n  \'size\' => \'1\',\n  \'defaultvalue\' => \'\',\n  \'outputtype\' => \'0\',\n  \'filtertype\' => \'0\',\n)','','','',0,1,0,1,0,1,1,0,0,0,0),
	(87,11,1,'products','主营产品或服务','','',0,0,'','','textarea','array (\n  \'width\' => \'60\',\n  \'height\' => \'125\',\n  \'defaultvalue\' => \'\',\n  \'enablehtml\' => \'0\',\n)','','','',0,1,0,1,1,1,1,0,1,0,0),
	(88,11,1,'genre','公司类型','','',1,30,'','','box','array (\n  \'options\' => \'企业单位|企业单位\r\n个体经营|个体经营\r\n事业单位或社会团体|事业单位或社会团体\r\n未经工商注册，个人|未经工商注册，个人\',\n  \'boxtype\' => \'radio\',\n  \'fieldtype\' => \'varchar\',\n  \'width\' => \'150\',\n  \'size\' => \'1\',\n  \'defaultvalue\' => \'未经工商注册，个人\',\n  \'outputtype\' => \'0\',\n  \'filtertype\' => \'0\',\n)','','','',0,1,0,1,0,1,1,0,2,0,0),
	(89,11,1,'areaname','公司所在地','','',1,10,'','','box','array (\n  \'options\' => \'北京|北京\r\n上海|上海\r\n杭州|杭州\r\n广州|广州\r\n深圳|深圳\r\n南京|南京\r\n武汉|武汉\r\n天津|天津\r\n成都|成都\r\n哈尔滨|哈尔滨\r\n重庆|重庆\r\n宁波|宁波\r\n无锡|无锡\r\n济南|济南\r\n苏州|苏州\r\n温州|温州\r\n青岛|青岛\r\n沈阳|沈阳\r\n福州|福州\r\n西安|西安\r\n长沙|长沙\r\n合肥|合肥\r\n南宁|南宁\r\n南昌|南昌\r\n郑州|郑州\r\n厦门|厦门\r\n大连|大连\r\n常州|常州\r\n石家庄|石家庄\r\n东莞|东莞\r\n安徽|安徽\r\n福建|福建\r\n甘肃|甘肃\r\n广东|广东\r\n广西|广西\r\n贵州|贵州\r\n海南|海南\r\n河北|河北\r\n黑龙江|黑龙江\r\n河南|河南\r\n湖北|湖北\r\n湖南|湖南\r\n江苏|江苏\r\n江西|江西\r\n吉林|吉林\r\n辽宁|辽宁\r\n内蒙古|内蒙古\r\n宁夏|宁夏\r\n青海|青海\r\n山东|山东\r\n山西|山西\r\n陕西|陕西\r\n四川|四川\r\n新疆|新疆\r\n西藏|西藏\r\n云南|云南\r\n浙江|浙江\r\n澳门|澳门\r\n台湾|台湾\r\n香港|香港\r\n惠州|惠州\r\n佛山|佛山\r\n珠海|珠海\r\n中山|中山\r\n海外|海外\r\n其它|其它\',\n  \'boxtype\' => \'select\',\n  \'fieldtype\' => \'varchar\',\n  \'width\' => \'\',\n  \'size\' => \'\',\n  \'defaultvalue\' => \'\',\n  \'outputtype\' => \'0\',\n  \'filtertype\' => \'0\',\n)','','','',0,1,0,1,0,1,1,0,3,0,0),
	(90,11,1,'address','经营地址','','',0,100,'','','text','array (\n  \'size\' => \'50\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','-99','-99',0,1,0,1,0,1,1,0,4,0,0),
	(91,11,1,'qq','企业QQ','','',0,0,'','','text','array (\n  \'size\' => \'20\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',0,1,0,1,0,1,1,0,0,0,0),
	(92,11,1,'web_url','官网网址','','',0,0,'','','text','array (\n  \'size\' => \'50\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',0,1,0,1,0,1,1,0,0,0,0),
	(93,12,1,'status','状态','','',0,2,'','','box','','','','',1,1,0,1,0,0,0,0,55,0,0),
	(94,12,1,'listorder','排序','','',0,6,'','','number','','','','',1,1,0,1,0,0,0,0,51,0,0),
	(95,12,1,'posids','推荐位','','',0,0,'','','posid','array (\n  \'cols\' => \'4\',\n  \'width\' => \'125\',\n)','','','',0,1,0,1,0,0,0,0,18,0,0),
	(96,12,1,'url','URL','','',0,100,'','','text','','','','',1,1,0,1,0,0,0,0,50,0,0),
	(97,12,1,'thumb','缩略图','','',0,100,'','','image','array (\n  \'size\' => \'50\',\n  \'defaultvalue\' => \'\',\n  \'show_type\' => \'1\',\n  \'upload_maxsize\' => \'1024\',\n  \'upload_allowext\' => \'jpg|jpeg|gif|png|bmp\',\n  \'watermark\' => \'0\',\n  \'isselectimage\' => \'1\',\n  \'images_width\' => \'\',\n  \'images_height\' => \'\',\n)','','','',0,1,0,0,0,1,0,1,5,0,0),
	(98,12,1,'pages','分页方式','','',0,0,'','','pages','','','','',0,0,0,1,0,1,0,0,16,0,0),
	(99,12,1,'inputtime','发布时间','','',0,0,'','','datetime','array (\n  \'fieldtype\' => \'int\',\n  \'format\' => \'Y-m-d H:i:s\',\n  \'defaulttype\' => \'0\',\n)','','','',0,1,0,0,0,0,0,1,17,0,0),
	...
	(101,12,1,'updatetime','更新时间','','',0,0,'','','datetime','array (\r\n  \'dateformat\' => \'int\',\r\n  \'format\' => \'Y-m-d H:i:s\',\r\n  \'defaulttype\' => \'1\',\r\n  \'defaultvalue\' => \'\',\r\n)','','','',1,1,0,1,0,0,0,0,12,0,0),
	(102,12,1,'keywords','关键词','多关键词之间用空格或者“,”隔开','',0,40,'','','keyword','array (\r\n  \'size\' => \'100\',\r\n  \'defaultvalue\' => \'\',\r\n)','','-99','-99',0,1,0,1,1,1,1,0,7,0,0),
	(103,12,1,'description','摘要','','',0,255,'','','textarea','array (\r\n  \'width\' => \'98\',\r\n  \'height\' => \'46\',\r\n  \'defaultvalue\' => \'\',\r\n  \'enablehtml\' => \'0\',\r\n)','','','',0,1,0,1,0,1,1,1,10,0,0),
	(104,12,1,'title','标题','','inputtitle',1,80,'','请输入标题','title','','','','',0,1,0,1,1,1,1,1,4,0,0),
	(105,12,1,'catid','分类','','',1,0,'/^[0-9]{1,6}$/','请选择栏目','catids','array (\n  \'boxtype\' => \'pop\',\n  \'filtertype\' => \'1\',\n)','','','',0,1,0,1,1,1,0,0,1,0,0),
	(106,12,1,'username','用户名','','',0,20,'','','text','','','','',1,1,0,1,0,0,0,0,98,0,0),
	(107,12,1,'elite','推荐','','',0,0,'','','box','array (\n  \'options\' => \'是|1\r\n否|0\',\n  \'boxtype\' => \'radio\',\n  \'fieldtype\' => \'tinyint\',\n  \'minnumber\' => \'1\',\n  \'width\' => \'40\',\n  \'size\' => \'1\',\n  \'defaultvalue\' => \'\',\n  \'outputtype\' => \'1\',\n  \'filtertype\' => \'0\',\n)','','','',0,1,0,1,0,1,0,0,14,0,0),
	(108,12,1,'typeid','类别','','',0,0,'','','typeid','array (\n  \'minnumber\' => \'\',\n  \'defaultvalue\' => \'\',\n)','','','',0,1,0,1,1,1,0,0,2,1,0),
	(109,13,1,'catid','产品分类','','',1,6,'/^[0-9]{1,6}$/','请选择栏目','catids','array (\n  \'boxtype\' => \'pop\',\n  \'filtertype\' => \'1\',\n)','','','',0,1,0,1,1,1,0,0,1,0,0),
	(110,13,1,'title','产品名称','','inputtitle',1,80,'','请输入标题','title','','','','',0,1,0,1,1,1,1,1,4,0,0),
	(111,13,1,'keywords','关键词','多关键词之间用空格或者“,”隔开','',0,40,'','','keyword','array (\r\n  \'size\' => \'100\',\r\n  \'defaultvalue\' => \'\',\r\n)','','-99','-99',0,1,0,1,1,1,1,0,7,0,0),
	(112,13,1,'updatetime','更新时间','','',0,0,'','','datetime','array (\r\n  \'dateformat\' => \'int\',\r\n  \'format\' => \'Y-m-d H:i:s\',\r\n  \'defaulttype\' => \'1\',\r\n  \'defaultvalue\' => \'\',\r\n)','','','',1,1,0,1,0,0,0,0,12,0,0),
	(113,13,1,'content','产品介绍','','',1,999999,'','内容不能为空','editor','array (\n  \'toolbar\' => \'basic\',\n  \'defaultvalue\' => \'\',\n  \'enablekeylink\' => \'1\',\n  \'replacenum\' => \'2\',\n  \'link_mode\' => \'0\',\n  \'enablesaveimage\' => \'1\',\n  \'height\' => \'\',\n  \'disabled_page\' => \'1\',\n)','','','',0,0,0,1,0,1,1,0,13,0,0),
	(114,13,1,'elite','推荐','','',0,0,'','','box','array (\n  \'options\' => \'是|1\r\n否|0\',\n  \'boxtype\' => \'radio\',\n  \'fieldtype\' => \'tinyint\',\n  \'minnumber\' => \'1\',\n  \'width\' => \'40\',\n  \'size\' => \'1\',\n  \'defaultvalue\' => \'\',\n  \'outputtype\' => \'1\',\n  \'filtertype\' => \'0\',\n)','','','',0,1,0,1,0,1,0,0,14,0,0),
	(115,13,1,'thumb','缩略图','','',0,100,'','','image','array (\n  \'size\' => \'50\',\n  \'defaultvalue\' => \'\',\n  \'show_type\' => \'1\',\n  \'upload_maxsize\' => \'1024\',\n  \'upload_allowext\' => \'jpg|jpeg|gif|png|bmp\',\n  \'watermark\' => \'0\',\n  \'isselectimage\' => \'1\',\n  \'images_width\' => \'\',\n  \'images_height\' => \'\',\n)','','','',0,1,0,0,0,1,0,1,6,0,0),
	(116,13,1,'inputtime','发布时间','','',0,0,'','','datetime','array (\n  \'fieldtype\' => \'int\',\n  \'format\' => \'Y-m-d H:i:s\',\n  \'defaulttype\' => \'0\',\n)','','','',0,1,0,0,0,0,0,1,17,0,0),
	(117,13,1,'posids','推荐位','','',0,0,'','','posid','array (\n  \'cols\' => \'4\',\n  \'width\' => \'125\',\n)','','','',0,1,0,1,0,0,0,0,18,0,0),
	(118,13,1,'url','URL','','',0,100,'','','text','array (\n  \'size\' => \'\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',1,1,0,1,0,0,0,1,50,0,0),
	(119,13,1,'listorder','排序','','',0,6,'','','number','','','','',1,1,0,1,0,0,0,0,51,0,0),
	(120,13,1,'status','状态','','',0,2,'','','box','','','','',1,1,0,1,0,0,0,0,55,0,0),
	(121,13,1,'username','用户名','','',0,20,'','','text','array (\n  \'size\' => \'\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',1,1,0,1,0,0,0,1,98,0,0),
	(122,13,1,'exhibit','展示图','','',0,0,'','','images','array (\n  \'upload_allowext\' => \'gif|jpg|jpeg|png|bmp\',\n  \'isselectimage\' => \'0\',\n  \'upload_number\' => \'10\',\n)','','','',0,0,0,1,0,1,0,0,6,0,0),
	(123,13,1,'standard','型号','','',0,0,'','','text','array (\n  \'size\' => \'20\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',0,0,0,1,0,1,1,0,5,0,0),
	(124,13,1,'brand','品牌','','',0,0,'','','text','array (\n  \'size\' => \'30\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',0,0,0,1,0,1,1,0,6,0,0),
	(125,13,1,'yieldly','商品产地','','',0,0,'','','text','array (\n  \'size\' => \'20\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',0,0,0,1,0,1,1,0,6,0,0),
	(126,13,1,'price','价格','','',0,0,'','','number','array (\n  \'minnumber\' => \'0\',\n  \'maxnumber\' => \'\',\n  \'decimaldigits\' => \'2\',\n  \'size\' => \'\',\n  \'defaultvalue\' => \'\',\n  \'rangetype\' => \'1\',\n)','','','',0,1,0,1,0,1,0,0,8,0,0),
	(127,13,1,'areaid','地区','','',0,0,'','','linkage','array (\n  \'linkageid\' => \'1\',\n  \'showtype\' => \'0\',\n  \'space\' => \'\',\n  \'filtertype\' => \'1\',\n)','','','',0,1,0,1,0,1,0,0,11,0,0),
	(128,13,1,'units','计量单位','','',0,0,'','','box','array (\n  \'options\' => \'把|把\r\n包|包\r\n本|本\r\n部|部\r\n打|打\r\n袋|袋\r\n单|单\r\n刀|刀\r\n吊|吊\r\n顶|顶\r\n对|对\r\n吨|吨\r\n幅|幅\r\n个|个\r\n根|根\r\n公斤|公斤\r\n公升|公升\r\n罐|罐\r\n毫米|毫米\r\n毫升|毫升\r\n盒|盒\r\n架|架\r\n件|件\r\n节|节\r\n具|具\r\n卷|卷\r\n卡|卡\r\n棵|棵\r\n颗|颗\r\n克|克\r\n块|块\r\n款|款\r\n厘米|厘米\r\n立方|立方\r\n立方根|立方根\r\n粒|粒\r\n辆|辆\r\n码|码\r\n枚|枚\r\n米|米\r\n面|面\r\n盆|盆\r\n片|片\r\n票|票\r\n平方厘米|平方厘米\r\n平方米|平方米\r\n平方英尺|平方英尺\r\n瓶|瓶\r\n千克|千克\r\n升|升\r\n束|束\r\n双|双\r\n台|台\r\n套|套\r\n条|条\r\n桶|桶\r\n头|头\r\n箱|箱\r\n英寸|英寸\r\n盏|盏\r\n张|张\r\n支|支\r\n只|只\r\n株|株\r\n组|组\r\n尊|尊\r\n座|座\',\n  \'boxtype\' => \'select\',\n  \'fieldtype\' => \'varchar\',\n  \'minnumber\' => \'1\',\n  \'width\' => \'80\',\n  \'size\' => \'1\',\n  \'defaultvalue\' => \'\',\n  \'outputtype\' => \'1\',\n  \'filtertype\' => \'0\',\n)','','','',0,0,0,1,0,1,0,0,8,0,0),
	(129,14,1,'catid','商机分类','','',1,0,'','请选择分类','catids','array (\n  \'boxtype\' => \'down\',\n  \'filtertype\' => \'1\',\n)','','','',0,1,0,1,1,1,0,0,1,0,0),
	(130,14,1,'title','商品名称','','inputtitle',1,120,'','请输入标题','title','','','','',0,1,0,1,1,1,1,1,4,0,0),
	(131,14,1,'keywords','关键词','多关键词之间用空格或者“,”隔开','',0,40,'','','keyword','array (\r\n  \'size\' => \'100\',\r\n  \'defaultvalue\' => \'\',\r\n)','','-99','-99',0,1,0,1,1,1,1,0,7,0,0),
	(132,14,1,'updatetime','更新时间','','',0,0,'','','datetime','array (\r\n  \'dateformat\' => \'int\',\r\n  \'format\' => \'Y-m-d H:i:s\',\r\n  \'defaulttype\' => \'1\',\r\n  \'defaultvalue\' => \'\',\r\n)','','','',1,1,0,1,0,0,0,0,12,0,0),
	(133,14,1,'content','商品介绍','','',1,999999,'','内容不能为空','editor','array (\n  \'toolbar\' => \'basic\',\n  \'defaultvalue\' => \'\',\n  \'enablekeylink\' => \'1\',\n  \'replacenum\' => \'2\',\n  \'link_mode\' => \'0\',\n  \'enablesaveimage\' => \'1\',\n  \'height\' => \'\',\n  \'disabled_page\' => \'1\',\n)','','','',0,0,0,1,0,1,1,0,13,0,0),
	(134,14,1,'brand','品牌','','',0,0,'','','text','array (\n  \'size\' => \'30\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',0,0,0,1,0,1,1,0,6,0,0),
	(135,14,1,'standard','商品型号','','',0,0,'','','text','array (\n  \'size\' => \'20\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',0,0,0,1,0,1,1,0,4,0,0),
	(136,14,1,'price','价格','','',0,0,'','','number','array (\n  \'minnumber\' => \'\',\n  \'maxnumber\' => \'\',\n  \'decimaldigits\' => \'2\',\n  \'size\' => \'20\',\n  \'defaultvalue\' => \'\',\n  \'rangetype\' => \'1\',\n)','','','',0,1,0,1,0,1,1,0,8,0,0),
	(137,14,1,'thumb','缩略图','','',0,100,'','','image','array (\n  \'size\' => \'50\',\n  \'defaultvalue\' => \'\',\n  \'show_type\' => \'1\',\n  \'upload_maxsize\' => \'1024\',\n  \'upload_allowext\' => \'jpg|jpeg|gif|png|bmp\',\n  \'watermark\' => \'0\',\n  \'isselectimage\' => \'1\',\n  \'images_width\' => \'\',\n  \'images_height\' => \'\',\n)','','','',0,1,0,0,0,1,0,1,5,0,0),
	(138,14,1,'inputtime','发布时间','','',0,0,'','','datetime','array (\n  \'fieldtype\' => \'int\',\n  \'format\' => \'Y-m-d H:i:s\',\n  \'defaulttype\' => \'0\',\n)','','','',0,1,0,0,0,0,0,1,17,0,0),
	(139,14,1,'posids','推荐位','','',0,0,'','','posid','array (\n  \'cols\' => \'4\',\n  \'width\' => \'125\',\n)','','','',0,1,0,1,0,0,0,0,18,0,0),
	(140,14,1,'url','URL','','',0,100,'','','text','','','','',1,1,0,1,0,0,0,0,50,0,0),
	(141,14,1,'listorder','排序','','',0,6,'','','number','','','','',1,1,0,1,0,0,0,0,51,0,0),
	(142,14,1,'status','状态','','',0,2,'','','box','','','','',1,1,0,1,0,0,0,0,55,0,0),
	(143,14,1,'username','用户名','','',0,20,'','','text','array (\n  \'size\' => \'\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',1,1,0,1,0,0,0,1,98,0,0),
	(144,14,1,'tid','商机类型','','',1,100,'','','box','array (\n  \'options\' => \'供应|1\r\n求购|2\r\n二手|3\r\n促销|4\',\n  \'boxtype\' => \'radio\',\n  \'fieldtype\' => \'tinyint\',\n  \'minnumber\' => \'1\',\n  \'width\' => \'80\',\n  \'size\' => \'1\',\n  \'defaultvalue\' => \'\',\n  \'outputtype\' => \'1\',\n  \'filtertype\' => \'1\',\n)','','','',0,1,0,1,0,1,0,0,0,0,0),
	(145,14,1,'elite','推荐','','',0,0,'','','box','array (\n  \'options\' => \'是|1\r\n否|0\',\n  \'boxtype\' => \'radio\',\n  \'fieldtype\' => \'tinyint\',\n  \'minnumber\' => \'1\',\n  \'width\' => \'40\',\n  \'size\' => \'1\',\n  \'defaultvalue\' => \'\',\n  \'outputtype\' => \'1\',\n  \'filtertype\' => \'0\',\n)','','','',0,1,0,1,0,1,0,0,14,0,0),
	(146,14,1,'areaid','地区','','',0,0,'','','linkage','array (\n  \'linkageid\' => \'1\',\n  \'space\' => \'\',\n  \'filtertype\' => \'1\',\n)','','','',0,1,0,1,0,1,0,0,10,0,0),
	(147,14,1,'yieldly','商品产地','','',0,0,'','','text','array (\n  \'size\' => \'20\',\n  \'defaultvalue\' => \'\',\n  \'ispassword\' => \'0\',\n)','','','',0,0,0,1,0,1,1,0,9,0,0),
	(148,14,1,'units','计量单位','','',0,0,'','','box','array (\n  \'options\' => \'把|把\r\n包|包\r\n本|本\r\n部|部\r\n打|打\r\n袋|袋\r\n单|单\r\n刀|刀\r\n吊|吊\r\n顶|顶\r\n对|对\r\n吨|吨\r\n幅|幅\r\n个|个\r\n根|根\r\n公斤|公斤\r\n公升|公升\r\n罐|罐\r\n毫米|毫米\r\n毫升|毫升\r\n盒|盒\r\n架|架\r\n件|件\r\n节|节\r\n具|具\r\n卷|卷\r\n卡|卡\r\n棵|棵\r\n颗|颗\r\n克|克\r\n块|块\r\n款|款\r\n厘米|厘米\r\n立方|立方\r\n立方根|立方根\r\n粒|粒\r\n辆|辆\r\n码|码\r\n枚|枚\r\n米|米\r\n面|面\r\n盆|盆\r\n片|片\r\n票|票\r\n平方厘米|平方厘米\r\n平方米|平方米\r\n平方英尺|平方英尺\r\n瓶|瓶\r\n千克|千克\r\n升|升\r\n束|束\r\n双|双\r\n台|台\r\n套|套\r\n条|条\r\n桶|桶\r\n头|头\r\n箱|箱\r\n英寸|英寸\r\n盏|盏\r\n张|张\r\n支|支\r\n只|只\r\n株|株\r\n组|组\r\n尊|尊\r\n座|座\',\n  \'boxtype\' => \'select\',\n  \'fieldtype\' => \'varchar\',\n  \'minnumber\' => \'1\',\n  \'width\' => \'80\',\n  \'size\' => \'1\',\n  \'defaultvalue\' => \'\',\n  \'outputtype\' => \'1\',\n)','','','',0,0,0,1,0,1,0,0,8,0,0),
	(149,14,1,'expiration','过期时间','','',1,0,'','','datetime','array (\n  \'fieldtype\' => \'int\',\n  \'format\' => \'Y-m-d\',\n  \'defaulttype\' => \'0\',\n)','','','',0,1,0,1,0,1,0,0,2,0,0);

/*!40000 ALTER TABLE `v9_model_field` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v9_module
# ------------------------------------------------------------
...
VALUES
	...
	('announce','公告','announce/',0,'1.0','公告','',0,0,'2013-07-07','2013-07-07'),
	('comment','评论','comment/',0,'1.0','评论','',0,0,'2013-07-07','2013-07-07'),
	('link','友情链接','',0,'1.0','','array (\n  1 => \n  array (\n    \'is_post\' => \'1\',\n    \'enablecheckcode\' => \'0\',\n  ),\n)',0,0,'2010-09-06','2010-09-06'),
	('vote','投票','',0,'1.0','','array (\r\n  1 => \r\n  array (\r\n    \'default_style\' => \'default\',\r\n    \'vote_tp_template\' => \'vote_tp\',\r\n    \'allowguest\' => \'1\',\r\n    \'enabled\' => \'1\',\r\n    \'interval\' => \'1\',\r\n    \'credit\' => \'1\',\r\n  ),\r\n)',0,0,'2010-09-06','2010-09-06'),
	('message','短消息','',0,'1.0','','',0,0,'2010-09-06','2010-09-06'),
	('mood','新闻心情','mood/',0,'1.0','新闻心情','',0,0,'2013-07-07','2013-07-07'),
	('poster','广告模块','poster/',0,'1.0','广告模块','',0,0,'2013-07-07','2013-07-07'),
	('formguide','表单向导','formguide/',0,'1.0','formguide','array (\n  \'allowmultisubmit\' => \'1\',\n  \'interval\' => \'30\',\n  \'allowunreg\' => \'0\',\n  \'mailmessage\' => \'用户向我们提交了表单数据，赶快去看看吧。\',\n)',0,0,'2010-10-20','2010-10-20'),
	('wap','手机门户','wap/',0,'1.0','手机门户','',0,0,'2013-07-07','2013-07-07'),
	('upgrade','在线升级','',0,'1.0','','',0,0,'2011-05-18','2011-05-18'),
	('tag','标签向导','tag/',0,'1.0','标签向导','',0,0,'2013-07-07','2013-07-07'),
	('sms','短信平台','sms/',0,'1.0','短信平台','',0,0,'2011-09-02','2011-09-02'),
	('yp','企业黄页','yp/',0,'1.0','企业黄页','array (\n  \'position\' => \n  array (\n    1 => \n    array (\n      \'posid\' => \'9\',\n      \'name\' => \'全局置顶\',\n      \'point\' => \'1\',\n      \'num\' => \'10\',\n    ),\n    2 => \n    array (\n      \'posid\' => \'8\',\n      \'name\' => \'列表置顶\',\n      \'point\' => \'2\',\n      \'num\' => \'5\',\n    ),\n  ),\n  \'ischeck\' => \'1\',\n  \'isbusiness\' => \'1\',\n  \'enable_rewrite\' => \'0\',\n  \'encode_page_cache\' => \'1\',\n  \'seo_title\' => \'北京黄页大全\',\n  \'seo_keywords\' => \'北京黄页大全 企业库 网上商店\',\n  \'seo_description\' => \'本站是北京地区最大、最全的企业库，欢迎入驻！\',\n  \'priv\' => \n  array (\n    8 => \n    array (\n      \'view\' => \n      array (\n        20 => \'1\',\n        19 => \'1\',\n        18 => \'1\',\n      ),\n    ),\n    2 => \n    array (\n      \'allowpostverify\' => \'1\',\n      20 => \'1\',\n      \'view\' => \n      array (\n        20 => \'1\',\n        19 => \'1\',\n        18 => \'1\',\n      ),\n      19 => \'1\',\n      18 => \'1\',\n    ),\n    6 => \n    array (\n      \'allowpostverify\' => \'1\',\n      20 => \'1\',\n      \'view\' => \n      array (\n        20 => \'1\',\n        19 => \'1\',\n        18 => \'1\',\n      ),\n      18 => \'1\',\n    ),\n    4 => \n    array (\n      \'allowpostverify\' => \'1\',\n      20 => \'1\',\n      \'view\' => \n      array (\n        20 => \'1\',\n        19 => \'1\',\n        18 => \'1\',\n      ),\n      19 => \'1\',\n    ),\n    5 => \n    array (\n      \'allowpostverify\' => \'1\',\n      20 => \'1\',\n      \'view\' => \n      array (\n        20 => \'1\',\n        19 => \'1\',\n        18 => \'1\',\n      ),\n      19 => \'1\',\n      18 => \'1\',\n    ),\n    1 => \n    array (\n      \'view\' => \n      array (\n        20 => \'1\',\n        19 => \'1\',\n        18 => \'1\',\n      ),\n    ),\n    7 => \n    array (\n      \'view\' => \n      array (\n        20 => \'1\',\n        19 => \'1\',\n        18 => \'1\',\n      ),\n    ),\n  ),\n)',0,0,'2013-07-07','2013-07-07');

/*!40000 ALTER TABLE `v9_module` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v9_mood
# ------------------------------------------------------------
...
INSERT INTO `v9_position` (`posid`, `modelid`, `catid`, `name`, `maxnum`, `extention`, `listorder`, `siteid`)
VALUES
...
# Dump of table v9_position_data
# ------------------------------------------------------------
...
INSERT INTO `v9_poster` (`id`, `siteid`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`)
VALUES
	(1,1,'banner',1,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://phpcms.dev/uploadfile/poster/2.png\',\n    \'alt\' => \'\',\n  ),\n)',1285813808,1446249600,1285813833,0,1,0,0),
	(2,1,'phpcmsv9',2,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://phpcms.dev/statics/images/v9/ad_login.jpg\',\n    \'alt\' => \'phpcms专业建站系统\',\n  ),\n)',1285816298,1446249600,1285816310,0,1,0,0),
	(3,1,'phpcms下载推荐',3,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://phpcms.dev/uploadfile/poster/3.png\',\n    \'alt\' => \'phpcms官方\',\n  ),\n)',1286504815,1446249600,1286504865,0,1,0,0),
	(4,1,'phpcms广告',4,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://phpcms.dev/uploadfile/poster/4.gif\',\n    \'alt\' => \'phpcms官方\',\n  ),\n)',1286505141,1446249600,1286505178,0,0,0,0),
	(5,1,'phpcms下载',5,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://phpcms.dev/uploadfile/poster/5.gif\',\n    \'alt\' => \'官方\',\n  ),\n)',1286509363,1446249600,1286509401,0,0,0,0),
...
INSERT INTO `v9_poster_space` (`spaceid`, `siteid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`)
VALUES
...
# Dump of table v9_release_point
# ------------------------------------------------------------
...
# Dump of table v9_search_keyword
# ------------------------------------------------------------
...
INSERT INTO `v9_session` (`sessionid`, `userid`, `ip`, `lastvisit`, `roleid`, `groupid`, `m`, `c`, `a`, `data`)
VALUES
	('l7fv1c6o3967t4sshii6mpvdj1',1,'127.0.0.1',1373203535,1,0,'admin','index','public_session_life','code|s:4:\"rbkr\";userid|s:1:\"1\";roleid|s:1:\"1\";pc_hash|s:6:\"dNN6Vv\";lock_screen|i:0;');

/*!40000 ALTER TABLE `v9_session` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v9_site
# ------------------------------------------------------------
...
INSERT INTO `v9_site` (`siteid`, `name`, `dirname`, `domain`, `site_title`, `keywords`, `description`, `release_point`, `default_style`, `template`, `setting`, `uuid`)
VALUES
	(1,'默认站点','','http://phpcms.dev/','PHPCMS演示站','PHPCMS演示站','PHPCMS演示站','','default','default','array (\n  \'upload_maxsize\' => \'2048\',\n  \'upload_allowext\' => \'jpg|jpeg|gif|bmp|png|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|rar|zip|swf\',\n  \'watermark_enable\' => \'1\',\n  \'watermark_minwidth\' => \'300\',\n  \'watermark_minheight\' => \'300\',\n  \'watermark_img\' => \'/statics/images/water/mark.png\',\n  \'watermark_pct\' => \'85\',\n  \'watermark_quality\' => \'80\',\n  \'watermark_pos\' => \'9\',\n)','3fa64a0e-e700-11e2-a3c6-c8524254e16b');

/*!40000 ALTER TABLE `v9_site` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v9_sms_report
# ------------------------------------------------------------
...
# Dump of table v9_special_c_data
# ------------------------------------------------------------
...
# Dump of table v9_special_content
# ------------------------------------------------------------
...
# Dump of table v9_sphinx_counter
# ------------------------------------------------------------
...
INSERT INTO `v9_sso_admin` (`id`, `username`, `password`, `encrypt`, `issuper`, `lastlogin`, `ip`)
VALUES
	(1,'admin','8ce9108f58c594c27ab30ce5547f95ae','flvH3e',1,0,'');

/*!40000 ALTER TABLE `v9_sso_admin` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v9_sso_applications
# ------------------------------------------------------------
...
INSERT INTO `v9_sso_applications` (`appid`, `type`, `name`, `url`, `authkey`, `ip`, `apifilename`, `charset`, `synlogin`)
VALUES
	(1,'phpcms_v9','phpcms v9','http://phpcms.dev/','yQGQAQSAgLeEhrAyrYwM8FrViiedHoF1','','api.php?op=phpsso','utf-8',1);

/*!40000 ALTER TABLE `v9_sso_applications` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v9_sso_members
# ------------------------------------------------------------
...
# Dump of table v9_sso_messagequeue
# ------------------------------------------------------------
...
INSERT INTO `v9_sso_settings` (`name`, `data`)
VALUES
	('denyemail',''),
	('denyusername',''),
	('creditrate',''),
...
INSERT INTO `v9_type` (`typeid`, `siteid`, `module`, `modelid`, `name`, `parentid`, `typedir`, `url`, `template`, `listorder`, `description`)
VALUES
...
INSERT INTO `v9_urlrule` (`urlruleid`, `module`, `file`, `ishtml`, `urlrule`, `example`)
VALUES
...
# Dump of table v9_video_content
# ------------------------------------------------------------
...
INSERT INTO `v9_wap` (`siteid`, `sitename`, `logo`, `domain`, `setting`, `status`)
VALUES
...
INSERT INTO `v9_workflow` (`workflowid`, `siteid`, `steps`, `workname`, `description`, `setting`, `flag`)
VALUES
	(1,1,1,'一级审核','审核一次','',0),
	(2,1,2,'二级审核','审核两次','',0),
	(3,1,3,'三级审核','审核三次','',0),
...
# Dump of table v9_yp_certificate
# ------------------------------------------------------------
...
# Dump of table v9_yp_product_data
# ------------------------------------------------------------
