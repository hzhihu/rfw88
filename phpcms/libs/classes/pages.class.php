	...
	/**
 	...
 	function set_data($array){
  		...
  		if(is_array($array)){
     		...
     		$perpage=(array_key_exists('epage',$array))?intval($array['epage']):pc_base::load_config('default_config','default_page');;//每页所要显示的条数
			...
			$canshu=(array_key_exists('canshu',$array))?$array['canshu']:'';//参数
     		...
     		$total=$array;
     		$perpage=pc_base::load_config('default_config','default_page');
     		$nowindex='1';
     		$url='';
     		$very_page='6';
     		$page_name='page';
